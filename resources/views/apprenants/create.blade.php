...
@endif
    ...
    <h1 class="mt-5 mb-4">Ajout Apprenants</h1>
        ...
        <div class="mb-3">
            ...
            <input name="nom" type="text" class="form-control" id="nom" placeholder="nom" value="{{ old('nom') }}">
        </div>
        <div class="mb-3">
            <label for="prenom">Prenom</label>
            <input name="prenom" type="text" class="form-control" id="prenom" placeholder="prenom" value="{{ old('prenom') }}">
        </div>
        <div class="mb-3">
            <label for="telephone">Telephone</label>
            <input name="telephone" type="tel" class="form-control" id="telephone" placeholder="telephone" value="{{ old('telephone') }}">
        </div>
        <div class="mb-3">
            <label for="matricule">Matricule</label>
            <input name="matricule"  type="text" class="form-control" id="matricule" placeholder="matricule" value="{{ old('matricule') }}">
        </div>
