   ...
   <form action="{{ route('apprenant.update', $apprenant->id) }}" method="post">
    ...
    <h1 class="mt-5 mb-4">Modifier Apprenant</h1>
        ...
        <div class="mb-3">
            ...
            <input name="nom" type="text" class="form-control" id="nom" placeholder="Nom" value="{{ $apprenant->nom }}">
        </div>
        <div class="mb-3">
            <label for="prenom">Prenom</label>
            <input name="prenom" type="text" class="form-control" id="prenom" placeholder="Prenom" value="{{ $apprenant->prenom }}">
        </div>
        <div class="mb-3">
            <label for="telephone">Telephone</label>
            <input name="telephone" type="tel" class="form-control" id="telephone" placeholder="Telephone" value="{{ $apprenant->telephone }}">
        </div>
        <div class="mb-3">
            <label for="matricule">Matricule</label>
            <input name="matricule"  type="text" class="form-control" id="matricule" placeholder="Matricule" value="{{ $apprenant->matricule }}">
        </div>
