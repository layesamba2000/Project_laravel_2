...
<div class="container">
  ...
  <tbody>
  @foreach($liste as $professeurs)
    <tr>
      <th scope="row">{{($professeurs->id)}}</th>
      <td>{{($professeurs->nomProf)}}</td>
      <td>{{($professeurs->prenomProf)}}</td>
      <td>{{($professeurs->numero)}}</td>
